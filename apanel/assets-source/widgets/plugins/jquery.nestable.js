...
(function($, window, document, undefined) {
    ...
    var defaults = {
        ...
        emptyClass: 'dd-empty',
        expandBtnHTML: '<button class="dd-expand" data-action="expand" type="button">Collapse</button>',
        collapseBtnHTML: '<button class="dd-collapse" data-action="collapse" type="button">Expand</button>',
        group: 0,
        maxDepth: 5,
        threshold: 20,
